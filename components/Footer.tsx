  ...
  return (
    <div className="flex flex-col items-center justify-between min-h-[400px] bg-black p-10">
      <div className="flex xs:flex-col lg:flex-row  xs:items-center  xl:items-start justify-between w-[1032.59px]  relative">
        <div className="text-red-nav text-left font-saira text-huge  relative">
          Shortly{" "}
        </div>

        <div className="flex flex-col gap-[17px] items-start justify-start shrink-0 relative">
          <div className="text-white text-left font-bold  relative w-[104px]">
            Features{" "}
          </div>
          <div className="text-soft-grey text-left  relative">
            Link Shortening{" "}
          </div>
          <div className="text-soft-grey text-left  relative">
            Branded Links{" "}
      ...
      <div className="flex flex-row items-center justify-between w-[1031.66px] h-[27px] relative">
        <div className="flex flex-row gap-[7px] items-center justify-start shrink-0 w-[198px] relative">
          <div className="flex flex-row gap-1 items-center justify-start ">
            ...
            <div className="text-[#ffffff] text-left font-bodytext-font-family text-bodytext-font-size leading-bodytext-line-height font-bodytext-font-weight relative">
              info@shortly.com{" "}
            </div>
          </div>
        </div>
