...
const Card = () => {
  return (
    <div
      className="bg-[#ffffff] pt-[17px] pr-[19px] pb-[17px] pl-[19px] flex flex-col items-start justify-between shrink-0 w-[332px] h-[513px] relative shadow-2xl  shadow-black
      "
